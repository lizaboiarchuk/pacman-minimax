...
class Pacman(Agent):
    ...
    def load_sprites(self):
        self.heart = pygame.image.load("pacmanSprites/heart.png")
        self.heart = pygame.transform.scale(self.heart, (self.app.cell_width, self.app.cell_height))
    ...
    def draw(self):
        ...
        for x in range(self.lives):
            self.app.screen.blit(self.heart, (30 + 25 * x, HEIGHT - 25))